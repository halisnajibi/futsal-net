            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Form Tambah Data Lapangan</h4>
                    </div>
                    <div class="card-body">
                        <form action="/admin/lapangans" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text"
                                                    ...
                                                    placeholder="nama lapangan" name="nama" value="{{ old('nama') }}">
                                                @error('nama')
                            ...
                            <div class="basic-form mt-5">
                                <div class="row">
                                    <div class="col-md">
                                        <img src="{{ asset('assets/images/lapangan/contoh-lapangan.jpg') }}"
                                            alt="foto sampul" width="30%" class="img-preview">
                                        <div class="mt-3">
                                    ...
                                    <div class="col-md">
                                        <div class="row">
                                            <div class="flex">
                                                <img alt="" width="30%" class="detail-preview">
                                            </div>
                                            <div class="mt-3">
